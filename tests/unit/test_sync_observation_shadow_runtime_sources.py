...
SCRIPT = ROOT / "scripts/student/sync_observation_shadow_runtime_sources.py"
SPEC = importlib.util.spec_from_file_location(
    "sync_observation_shadow_runtime_sources", SCRIPT
)
        ...
        json.dumps(
            {
                ...
                "runtime_source_normalized_sha256": hashes,
            }
        ),
        encoding="utf-8",
    )
