...
# Run exactly one train-only Base/PGRR pair for the crossing-flow anchor.
# The script defaults to a dry run, verifies immutable inputs, and refuses to
# overwrite an earlier attempt.  It is exploratory screening, not evaluation.
...
scenario_id=crossing_flow_medium_anchor_v1_train_r00_s95010
scenario_relative=outputs/student/advantage_scenario_screen/generated/arena/map_empty/${scenario_id}.json
scenario_sha=719fcb4ce9710895b95d3e8932f4fef21816258b05bd2271188f6fcc5f76b8d7
runtime_scenario_relative=outputs/student/advantage_scenario_screen/scenarios/${scenario_id}.json
...
result_relative=outputs/student/advantage_scenario_screen/runtime
...
for method in "${method_list[@]}"; do
  episode_id="pgrr_advscreen_crossing_medium_train_s95010_${method}"
  protected=(
...
echo "PREFLIGHT PASS: dry_run=$dry_run methods=$methods scenario=$scenario_id"
